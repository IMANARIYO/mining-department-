              ...
              <form className="space-y-6">
                <div className="grid gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="project-manager" placeholder="Enter project manager name" />
                  </div>
                ...
                <Button type="submit" className="bg-amber-800 hover:bg-amber-900">Save Site Information</Button>
              </form>
            </CardContent>
          </Card>
        </TabsContent>
              ...
              <form className="space-y-6">
                <div className="grid gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="tunnel-length" type="number" placeholder="Enter length" />
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="tunnel-diameter">Diameter (m)</Label>
                      <Input id="tunnel-diameter" type="number" step="0.1" placeholder="Enter diameter" />
                    </div>
                    
                    <div className="space-y-2">
                      <Label htmlFor="tunnel-cross-section">Cross-Section Area (m²)</Label>
                      <Input id="tunnel-cross-section" type="number" step="0.1" placeholder="Enter cross-section area" />
                    </div>
                  </div>
                </div>
                
                <Button type="submit" className="bg-amber-800 hover:bg-amber-900">Save Tunnel Dimensions</Button>
              </form>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent>
              <form className="space-y-6">
                <div className="grid gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="advancement-distance">Advancement Distance (m)</Label>
                    <Input id="advancement-distance" type="number" step="0.1" placeholder="Enter distance" />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="tbm">Tunnel Boring Machine (TBM)</SelectItem>
                        <SelectItem value="drill-blast">Drill and Blast</SelectItem>
                        <SelectItem value="natm">New Austrian Tunneling Method</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="advancement-notes" placeholder="Enter notes" rows={4} />
                  </div>
                </div>
                
                <Button type="submit" className="bg-amber-800 hover:bg-amber-900">Record Advancement</Button>
              </form>
              
              <div className="mt-8">
                <h3 className="text-lg font-medium mb-4">Recent Advancements</h3>
                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="blast-location" type="number" step="0.1" placeholder="Enter chainage" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="hole-count" type="number" placeholder="Enter hole count" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="explosive-quantity">Explosive Quantity (kg)</Label>
                      <Input id="explosive-quantity" type="number" step="0.1" placeholder="Enter quantity" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="blast-notes" placeholder="Enter notes" rows={4} />
                  </div>
                </div>
                
                <Button type="submit" className="bg-amber-800 hover:bg-amber-900">Record Blast</Button>
              </form>
              
              <div className="mt-8">
                <h3 className="text-lg font-medium mb-4">Recent Blast Records</h3>
                <div className="rounded-md border">
                  <Table>
                    <TableHeader>
                      <TableRow>
